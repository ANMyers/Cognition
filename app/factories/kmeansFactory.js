...
app.factory("kmeansFactory", function(){

console.log("kmeansFactory loaded");

// var clusterMaker = require("../lib/node_modules/clusters/clusters.js");
...
console.log("clustermaker: ", clusterMaker);

return {clusterMaker, kmeans, Point, Centroid, getterSetter, sumOfSquareDiffs, mindex, sumVectors, averageLocation};
